 ...
 * @private
 */
	this.init_naver_id_login = function (access_type)
	{
		...
		{	
			...
			*/
			// naver_login() 함수는 naver_login.js 에 있다.
			naver_id_popup_option = " onClick=\"naver_login('"+access_type+"', this.href); return false\" ";
		}
		...
		else 
		{
			if(access_type == "login") {
				var img_name = "login_02";
			} else {
				var img_name = "signup_02";
			}
			...
			naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor'><img src=\"/img/btn/naver_login.png\"  /></a> ";
		}
