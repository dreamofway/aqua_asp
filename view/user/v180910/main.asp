...
<%
	...
	Dim call_db_popup
	call_db_popup = getPopupInfo("180808P1009")
...
%>
    ...
    <div class="container">
        <div class="main_news_combi" >
            ...
            <div class="main_news_left">
                <div class="main_news" style="margin-bottom:0px" >
                    <div class="main_area_center " style="border-left: 1px solid #d0d0d0;border-right: 1px solid #d0d0d0;border-bottom: 1px solid #d0d0d0;height: 782px; background: #fff; margin-bottom: 12px">
            ...
            <div class="area_right ">
                <div class="line_right ">
                    ...
                    <div class="area_right_title ">
                        <span><a href="news/list?catr=1107 ">카드뉴스</a></span>
            ...
            <div class="main_news_thumblist_fin">
                ...
                <article class="right" style="float: left; width: 409px">
					<%
						...
						If Ubound( main_news_arr ) > -1 Then 
					%>
                    <div class="main_keyword" style="width: 409px;">우리아이 포스트
					<!--
					<span><a href="http://post.naver.com/my/series/detail.nhn?seriesNo=255319&memberNo=35540755" style="color: #8b8b8b">키즈헬스</a><span style="padding: 0 10px; color: #8b8b8b">|</span><a href="http://post.naver.com/my/series/detail.nhn?seriesNo=255416&memberNo=35540755" style="color: #8b8b8b">건강정보</a></span>
					-->
		...
		<div class="main_news_combi ">
            <div class="main_news_left ">
                <div class="main_news" style="border-top:none">
                    ...
                    <div class="main_news_keyword ">
						<%
							...
							If Ubound( main_news_arr ) > -1 Then 
						%>
                        <div class="main_keyword ">기획<span></span>
                            <!--<p class="main_more">
                ...
                <!-- main_news //-->
				 ...
				 <div class="main_news_thumb3 ">
                    <div class="main_keyword ">산업<span></span>
                        <p class="main_more">
                ...
                <div class="main_news_thumb3 ">
                    <div class="main_keyword ">사회/정책<span></span>
                        <p class="main_more">
                            <a href="/news/list?catr=1201"><img src="<%=wm.image_path%>/inc/more_con.jpg" alt=""></a>
                        </p>
                    </div>
                    <div class="main_area_center ">
						<%
            ...
            <div class="area_right ">
                ...
                <div class="area_right_baner " style="padding:8px 0px;height:auto" >
                   <a href="https://play.google.com/store/apps/details?id=com.compa.ikn" target="_blank" title="우리아이뉴스 앱 다운로드 새창이동">
						<img src="http://img.compa.kr/ikn/banner/right_ikn_app_300x250.jpg" alt="우리아이뉴스 앱 배너" />
					</a>
                </div> <!-- area_right_photobox //-->


				<div class="area_right_mostviewed " style="height: 592px; margin-top:12px; margin-bottom: 15px; border-left: 1px solid #d0d0d0; border-right: 1px solid #d0d0d0; border-top: 2px solid #000;"">
	 				<div class="area_right_title "> 
                        <span>우리아이 위한 식품안전정보
							<p class="main_more" style="padding: 0px 0px;">
        	               		<a href="/news/list?catr=1604"><img src="<%=wm.image_path%>/inc/more_con.jpg" alt=""></a>
    	                	</p>
						</span>
                        ...
                        <div class="right_list_box ">
							<%
								main_news_arr = wm.getVal("result_food_security_news")
							...
							%>
                            <div class="area_right_list" style="padding: 10px 0;" >
                            ...
                            <div class="area_right_list " style="padding: 9px 0;">
                                <p class="list_n "><%=( loop_cnt + 1)%></p>
		...
		<div class="main_news_combi_2rows ">
            ...
            <div class="main_news_thumblist ">
                <div class="main_keyword ">칼럼<span></span>
					<p class="main_more">
                        <a href="/news/list?catr=1303"><img src="<%=wm.image_path%>/inc/more_con.jpg" alt=""></a>
                    </p>
		...
		<div >
            <div class="main_news_left ">               
                ...
                <div class="main_news_thumb3 ">
                    <div class="main_keyword ">마디터<span></span>
                        <p class="main_more">
                            <a href="/news/list?catr=15"><img src="<%=wm.image_path%>/inc/more_con.jpg" alt=""></a>
                        </p>
                    </div>
                    <div class="main_area_center ">
						<%
            ...
            <div class="area_right ">
				...
				<div class="area_right_baner" >
					<a href="http://maditor.ikn.kr/" target="_blank" title="마디터 사이트 새창이동">
						<img src="http://img.compa.kr/ikn/banner/right_maditor_300x250.jpg"alt="마디터 모집배너"  />
					</a>
                </div>
    ...
    <script id="tmplate_main_popup" type="text/x-jquery-tmpl">
		...
		<script type="text/javascript">
			console.log(<%=call_db_popup%>)
			var call_db_popup = <%=call_db_popup%>		
			for (var i in call_db_popup) {
				if (call_db_popup[i] != null) {
					call_db_popup[i].usePagination = true;	//페이지 인디케이터
					//call_db_popup[i].useControlBtn = true;	//컨트롤 패널
					//call_db_popup[i].ctrlColor = "#000000ba";	//컨트롤 패널 색상 설정
					//call_db_popup[i].slideSpeed = 5000;	//팝업 속도 설정
					//call_db_popup[i].popupImgScale = null;	//팝업 크기 설정 X
					call_db_popup[i].bgColor = "transparent";	//팝업 배경색 설정
					call_db_popup[i].borderColor = "transparent";	//border 색상 설정
					call_db_popup[i].useImgScaleAdjustment = true;	//팝업 이미지 사이즈 조정 설정

					popupSet(call_db_popup[i]);
				} 
			}
		</script>
