...
<!--		<link rel="stylesheet" href="<%=wm.user_view_path%>/css/init.css?ver=<%=verMake()%>" type="text/css" />-->
		...
		<link rel="stylesheet" href="<%=wm.user_view_path%>/css/common.css?ver=<%=verMake()%>" type="text/css" />
	    <link rel="stylesheet" href="<%=wm.user_view_path%>/css/index.css?ver=<%=verMake()%>" type="text/css" />
		...
		<script type="text/javascript" src="<%=wm.user_view_path%>/js/jquery.call_db_popup.js"></script>
		...
		<style type="text/css">
			...
			.search_box {position:relative;float:right;margin:0px;}
			.search_box input[type=text] {width: 327px; height:36px; padding: 0px 5px; margin-top:-4px;border:none}
			.search_box input[type=text] {outline: none;}
			.search_box input[type=text]:focus {width: 327px; height: 36px; border:2px solid mediumvioletred; padding: 0px 5px;margin-top:-4px}
			.search_box img.search_icon {width: 16px; position: absolute; right: 6px; top: 50%; -webkit-transform: translateY(-50%); transform: translateY(-50%); cursor: pointer;}
