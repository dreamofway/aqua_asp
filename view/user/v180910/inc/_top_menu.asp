				...
				<!--
					...
					<div>
						<div class="search_box">
							<form name="search_form" id="search_form" action="/news/list" >
								<input type="text" name="search_keyword" id="search_keyword" placeholder="기사의 제목,내용을 검색해주세요.">
								<img src="http://img.compa.kr/ikn/news/inc/search_icon.png" class="search_icon" id="btn_search" alt="검색">
							</form>
						</div>
					</div>
				</div>        
							...
							<li class="gnb_2dep">
								...
								<div class="slide_news_area">
									<ul>
										...
										%>
										<li class="gnb_3dep">
											<a href="/news/view?ArticleID=<%=menu_rs("ArticleID")%>&catr=<%=cutCatrCode( menu_rs("CatrCode") )%>">
												<%
